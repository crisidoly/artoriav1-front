...
import { FileText, LayoutGrid, List as ListIcon, Plus, Search } from "lucide-react";
       ...
       <div className="flex items-center justify-between shrink-0">
          <div>
              <h1 className="text-3xl font-bold tracking-tight text-white mb-1">
                  <span className="text-primary-glow">Google</span> Docs
              </h1>
              <p className="text-muted-foreground">Gerencie seus dcoumentos e arquivos de texto.</p>
          </div>
       </div>
          ...
          <div className="h-16 border-b border-white/5 flex items-center px-6 gap-6 shrink-0 justify-between">
              ...
              <div className="relative flex-1 max-w-xl">
                  ...
                  <Input 
                      ...
                      className="pl-9 bg-secondary/20 border-white/10 focus-visible:ring-blue-500/50 rounded-full h-9"
                  />
              </div>

              <div className="flex items-center gap-2">
                  <Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-white gap-2 h-9" onClick={() => window.open('https://docs.new', '_blank')}>
