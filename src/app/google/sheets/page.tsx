...
import { ArrowUpDown, ChevronRight, FileSpreadsheet, LayoutGrid, List as ListIcon, Plus, Search } from "lucide-react";
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-background/50">
        ...
        <div className="h-16 border-b border-white/5 flex items-center px-6 gap-6 shrink-0 justify-between">
             <div className="flex items-center gap-2 text-green-400">
                ...
                <h1 className="font-semibold text-lg text-foreground">Planilhas</h1>
             </div>
             ...
             <div className="relative flex-1 max-w-xl">
                ...
                <Input 
                    ...
                    className="pl-9 bg-secondary/20 border-white/10 focus-visible:ring-green-500/50 rounded-full"
                />
             </div>

             <div className="flex items-center gap-2">
                 <Button className="bg-green-600 hover:bg-green-700 text-white gap-2" onClick={() => window.open('https://sheets.new', '_blank')}>
        ...
        <ScrollArea className="flex-1 p-6">
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                <div className="flex items-center gap-2 text-lg font-medium text-foreground/80">
                    <span className="hover:bg-white/5 px-2 py-1 rounded cursor-pointer">Todas as Planilhas</span>
                    <ChevronRight className="h-5 w-5 text-muted-foreground" />
                </div>

                {isLoading ? (
                     <div className="text-center py-20 text-muted-foreground animate-pulse">
                         Carregando planilhas do Google...
                     </div>
                ) : error ? (
                     <div className="text-center py-20 text-red-400">
                         Erro ao carregar planilhas. Verifique sua conexão com o Google.
                     </div>
                ) : (
                    /* Files */
