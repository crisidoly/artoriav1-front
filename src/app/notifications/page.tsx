...
export default function NotificationsPage() {
   ...
   return (
      <div className="container mx-auto max-w-4xl py-10 text-white font-sans h-screen flex flex-col">
         ...
         {/* List */}
         <Card className="flex-1 bg-black/40 border-white/10 overflow-hidden flex flex-col">
